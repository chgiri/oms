...
/**
 * Tracing counterpart to {@link com.giri.oms.common.correlation.MdcCorrelation}.
 *
 ...
 * (spring.kafka.template.observation-enabled) would otherwise start a brand
 * new, disconnected trace for every publish. That's fine for the "what did
 * this poll do" question, but it breaks the saga-wide "why did this order
 * take 4 seconds to move from PENDING to CONFIRMED" question, since the
 * publish trace has no relationship back to the request that enqueued it.
 *
